...
export const HeroSection = () => {
    return (
        <section className='bg-hero-background w-full bg-cover bg-no-repeat bg-blend-darken pt-[120px] px-5 flex flex-col items-center gap-10 py-14'>
            <div className='mt-10'>
            ...
            <Button buttonText='Contacto' color='secondary' variant='filled' href='/contact'/>
            {/* <Link href={"/"}>Test</Link> */}
        </section>
    )
}
